...
namespace IngameScript
{
    public class Program : MyGridProgram
    {
        ...
        List<IMySolarPanel> solarBlocks = new List<IMySolarPanel>();
        ...
        public void Main(string argument)
        {
            ...
            GridTerminalSystem.GetBlocksOfType<IMySolarPanel>(solarBlocks);
            ...
            foreach (IMySolarPanel block in solarBlocks)
            {
                P_solarpanel += block.CurrentOutput;
            }

            foreach (IMyReactor block in reactorBlocks)
            {
